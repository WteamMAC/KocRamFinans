...
const TAG_COLORS: Record<string, string> = {
    "Kripto": "text-orange-500 bg-orange-50 border-orange-200",
    "BIST": "text-emerald-500 bg-emerald-50 border-emerald-200",
    "Küresel / ABD": "text-blue-500 bg-blue-50 border-blue-200",
    "Emtia / Altın": "text-amber-500 bg-amber-50 border-amber-200",
    "Döviz / Makro": "text-indigo-500 bg-indigo-50 border-indigo-200",
    "Genel Ekonomi": "text-slate-500 bg-slate-50 border-slate-200"
};
