      ...
      <div className="w-full space-y-6 md:space-y-8">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <Card className="lg:col-span-1 border-border/30 shadow-ambient-medium rounded-[32px] overflow-hidden bg-card h-fit">
                <CardHeader className="bg-primary/5 border-b border-border/10 h-14 md:h-16 flex items-center px-5 md:px-8">
                  <CardTitle className="text-base md:text-lg">Hesaplama Parametreleri</CardTitle>
                </CardHeader>
        ...
        {activeTab === "bes" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <Card className="lg:col-span-1 border-border/30 shadow-ambient-medium rounded-[32px] overflow-hidden bg-card h-fit">
                <CardHeader className="bg-emerald-500/5 border-b border-border/10 h-14 md:h-16 flex items-center px-5 md:px-8">
                  <CardTitle className="text-base md:text-lg">BES Planı Parametreleri</CardTitle>
                </CardHeader>
        ...
        {activeTab === "leverage" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <Card className="lg:col-span-1 border-border/30 shadow-ambient-medium rounded-[32px] overflow-hidden bg-card h-fit">
                <CardHeader className="bg-orange-500/5 border-b border-border/10 h-14 md:h-16 flex items-center px-5 md:px-8">
                  <CardTitle className="text-base md:text-lg">Pozisyon Parametreleri</CardTitle>
                </CardHeader>
                <CardContent className="p-8 space-y-8">
