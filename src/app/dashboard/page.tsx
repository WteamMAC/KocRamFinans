  ...
  return (
    <div className="space-y-6 md:space-y-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4 md:gap-8 w-full">
        <Card className="col-span-1 md:col-span-1 lg:col-span-4 bg-card border-border/20 shadow-ambient-medium rounded-[32px] overflow-hidden flex flex-col w-full pt-0">
          <PerformanceChart 
